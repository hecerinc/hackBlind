...
export default class Alpha extends React.Component {
	...
	registerLandmark() {
		Alert.alert('Go to register landmark!');
	}
	render() {
		return(
			<View style={{flex: 1}}>
				<TouchableWithoutFeedback onPress={this.registerLandmark}>
					<View style={styles.halfWidth}>
						<Text style={styles.bigFonts}>Register landmark</Text>
					</View>
				</TouchableWithoutFeedback>
				<TouchableWithoutFeedback onPress={this.viewLandmark} >
					<View style={[styles.halfWidth, {backgroundColor: '#242423'}]}>
						<Text style={styles.bigFonts}>View landmark</Text>
					</View>
				</TouchableWithoutFeedback>
			</View>
		)
